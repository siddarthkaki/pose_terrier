...
%iidx = find(ptl_data.Time <= 20.0519 | ptl_data.Time > 20.3802);
% iidx = find(ptl_data.Time <= 8.50004 | ...
%            (ptl_data.Time >= 8.76194 & ptl_data.Time <= 37.5301) | ...
%            (ptl_data.Time >= 37.7801 & ptl_data.Time <= 45.7921) | ...
%            (ptl_data.Time >= 46.0414));

iidx = find(ptl_data.Time <= 11.5113 | ...
           (ptl_data.Time >= 11.7615 & ptl_data.Time <= 50.0415) | ...
           (ptl_data.Time >= 50.2918));

% iidx = find(ptl_data.Time <= 20.0101 | ptl_data.Time >= 20.3101);
