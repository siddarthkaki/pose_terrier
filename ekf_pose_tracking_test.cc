...
int main(int argc, char** argv)
{
    ...
    for (unsigned int pose_idx = 0; pose_idx < num_poses_test; pose_idx++)
    {
        ...
        else // else, perform KF tracking
        {
            ...
            pose_meas_wrapper.tail(3) = pose_sol.pose.quat.normalized().toRotationMatrix().eulerAngles(0, 1, 2);
            ...
            conj_pose_meas_wrapper.tail(3) = conj_pose.quat.normalized().toRotationMatrix().eulerAngles(0, 1, 2);
